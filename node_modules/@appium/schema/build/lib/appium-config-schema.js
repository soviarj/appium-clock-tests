        ...
        server: {
            ...
            properties: {
                ...
                'keep-alive-timeout': {
                    appiumCliAliases: ['ka'],
                    default: 600,
                    description: 'Number of seconds the Appium server should apply as both the keep-alive timeout and the connection timeout ' +
                ...
                'request-timeout': {
                    default: 3600,
                    description: 'Number of seconds the Appium server should apply for receiving the entire HTTP request from the client. ' +
