...
const findRootCached = (0, util_1.memoize)(package_directory_1.packageDirectorySync, (opts) => opts?.cwd);
    ...
    async mv(from, to, opts = {}) {
        ...
        try {
            ...
            if (isErrnoException(err) && err.code === 'ENOENT') {
                throw new Error(`The source path '${from}' does not exist or is not accessible`, { cause: err });
            }
            throw err;
        }
        if (fromStat.isFile()) {
