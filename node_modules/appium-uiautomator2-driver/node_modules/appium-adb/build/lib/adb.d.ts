...
export declare const DEFAULT_OPTS: {
    ...
    readonly listenAllNetwork: false;
};
export declare class ADB implements ADBOptions {
    ...
    listInstalledPackages: typeof appCommands.listInstalledPackages;
    ...
    getVersion: ((this: ADB) => Promise<import("./tools/types").Version>) & {
        cache: Map<unknown, Promise<import("./tools/types").Version>>;
    };
