...
export declare const getBinaryNameForOS: typeof _getBinaryNameForOS & {
 ...
 */
export declare const resetTelnetAuthToken: (() => Promise<boolean>) & {
 ...
 */
export declare const getVersion: ((this: ADB) => Promise<Version>) & {
    cache: Map<unknown, Promise<Version>>;
};
/**
 ...
 */
export declare const getBuildToolsDirs: ((sdkRoot: string) => Promise<string[]>) & {
