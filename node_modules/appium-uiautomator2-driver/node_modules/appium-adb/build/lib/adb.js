...
class ADB {
    ...
    constructor(opts = {}) {
        const options = (0, utils_1.defaultsDeep)(opts, (0, utils_1.cloneDeep)(exports.DEFAULT_OPTS));
        (0, utils_1.defaultsDeep)(this, options);
    ...
    static async createADB(opts = {}) {
        ...
        adb.sdkRoot = await (0, utils_1.requireSdkRoot)(adb.sdkRoot);
     ...
     */
    clone(opts = {}) {
        const originalOptions = (0, utils_1.cloneDeep)((0, utils_1.pick)(this, Object.keys(exports.DEFAULT_OPTS)));
        const cloneOptions = (0, utils_1.defaultsDeep)(opts, originalOptions);
