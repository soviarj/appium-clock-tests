 ...
 */
export declare function getNotifications(this: SettingsApp): Promise<Record<string, any>>;
/**
 ...
 */
export declare function adjustNotificationsPermissions(this: SettingsApp): Promise<boolean>;
