...
async function getSmsList(opts = {}) {
    this.log.debug(logger_1.LOG_PREFIX, 'Retrieving the recent SMS messages');
    const args = ['-n', constants_1.SMS_LIST_RECEIVER, '-a', constants_1.SMS_LIST_RETRIEVAL_ACTION];
    if (opts.max) {
