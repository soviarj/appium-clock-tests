...
async function getClipboard() {
    ...
    const retrieveClipboard = async () => await this.checkBroadcast(['-n', constants_1.CLIPBOARD_RECEIVER, '-a', constants_1.CLIPBOARD_RETRIEVAL_ACTION], 'retrieve clipboard', false);
    let output;
    try {
        output =
