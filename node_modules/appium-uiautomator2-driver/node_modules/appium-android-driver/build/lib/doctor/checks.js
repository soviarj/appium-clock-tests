...
class JavaHomeValueCheck {
    ...
    async diagnose() {
        ...
        const javaBinaryRelativePath = node_path_1.default.join('bin', `java${support_1.system.isWindows() ? '.exe' : ''}`);
        const javaBinary = node_path_1.default.join(envVar, javaBinaryRelativePath);
