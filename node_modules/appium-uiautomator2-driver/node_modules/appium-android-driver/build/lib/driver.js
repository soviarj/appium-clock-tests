...
class AndroidDriver extends driver_1.BaseDriver {
    ...
    _bidiProxyUrl = null;
    _chromedriverCapsCache = new lru_cache_1.LRUCache({
        max: 20,
        updateAgeOnGet: true,
    });
    opts;
    ...
    mobileGetChromeCapabilities = exports_1.mobileGetChromeCapabilities;
    ...
    mobileListApps = app_management_1.mobileListApps;
