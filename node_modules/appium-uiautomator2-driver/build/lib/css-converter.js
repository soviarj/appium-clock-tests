...
class CssConverter {
    ...
    parseAttr(cssAttr) {
        ...
        if (typeof attrValue !== 'string' && !(0, utils_1.isEmpty)(attrValue)) {
        ...
        switch (cssAttr.operator) {
            ...
            case '*=':
                ...
                return `.${methodName}Matches("${(0, utils_1.escapeRegExp)(value)}")`;
            case '^=':
                if (['description', 'text'].includes(attrName)) {
    ...
    parsePseudo(cssPseudo) {
        ...
        if (typeof argValue !== 'string' && !(0, utils_1.isEmpty)(argValue)) {
    ...
    parseCssObject(css) {
        if (!(0, utils_1.isEmpty)(css.rules)) {
...
function getWordMatcherRegex(word) {
    return `\\b(\\w*${(0, utils_1.escapeRegExp)(word)}\\w*)\\b`;
}
