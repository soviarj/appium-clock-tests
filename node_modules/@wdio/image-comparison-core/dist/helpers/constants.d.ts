...
export declare const DEFAULT_COMPARE_OPTIONS: {
...
export declare const DEVICE_RECTANGLES: DeviceRectangles;
...
export declare const DEFAULT_TEST_CONTEXT: TestContext;
