...
class AppiumInitializer {
    ...
    async parsePreConfigArgs(args) {
        ...
        if (args) {
            ...
            const preConfigArgs = { ...args, subcommand: args.subcommand ?? constants_1.SERVER_SUBCOMMAND };
