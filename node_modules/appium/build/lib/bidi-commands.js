...
function determineBiDiHost(address) {
    ...
    const nonLocalInterfaces = (0, network_1.fetchInterfaces)(address === network_1.V4_BROADCAST_IP ? 4 : 6)
...
async function assertIsOpen(ws, timeoutMs = 5000) {
    ...
    try {
        await new Promise((resolve, reject) => {
            setTimeout(() => reject(new Error(`The BiDi web socket at ${ws.url} did not ` +
                `open after ${timeoutMs}ms timeout`)), timeoutMs);
